...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <p>Enter EMP_ID of Employee To be Removed</p>
    <div class="container">
        <div class="form" style="text-align: center;">
            <form name = "addempform" action = "removemp.php" method="post">
                ...
                <div class="submit-btn" style="text-align: center;">
                    <button type='submit' id='btn' onclick="return confirm('Do you really want to remove this employee?');">Submit</button>
                </div>
            </form>
        </div>
    </div>
    ...
    if(isset($_POST['empid']))
    {
        ...
        $empid = $_POST['empid'];
        $sql = "DELETE FROM `emp_details` WHERE `emp_details`.`emp_id`=$empid";
        ...
        {  
            echo "Failed to remove data : ".mysqli_error();
        }
    }
